...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/kong-admin-api.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/kong-admin-api)
...
```php
$skeleton = new CleaniqueCoders\KongAdminApi();
